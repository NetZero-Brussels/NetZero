...
export function ContributionCard() {
    ...
    return (
        <div className='flex flex-col gap-[32px]'>
            ...
            <div id='first-row' className='flex flex-row gap-[24px] content-center justify-around'>
            ...
            <div id='second-row' className='flex flex-row gap-[24px] content-center justify-around'>
                <div id='col2_1' className='flex flex-col p-[11px] gap-[5px]  items-center'>
                ...
                <div id='col2_2' className='flex flex-col p-[11px] gap-[2px] items-center justify-center h-[105px]'>
